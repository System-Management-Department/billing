{block name="title"}入金区分編集画面{/block}
			...
			<table class="table w-50">
				<tr>
					<th scope="row" class="bg-light align-middle ps-4">
						<label class="form-label ls-1" for="code-input">入金区分コード</label>
					</th>
					<td>
						<div class="col-3">
				...
				<tr>
					<th scope="row" class="bg-light align-middle ps-4">
						<label class="form-label ls-1" for="type-input">入金種別　<span class="text-danger fw-light">※</span></label>
					</th>
					<td>
						<div class="col-10">
							<select name="type" class="form-select" id="type-input">{foreach from=["" => "選択"]|paymentType item="text" key="value"}
								<option value="{$value}"{if $data.type eq $value} selected{/if}>{$text}</option>
							{/foreach}</select>
				...
				<tr>
					<th scope="row" class="bg-light align-middle ps-4">
						<label class="form-label ls-1" for="name-input">入金区分名　<span class="text-danger fw-light">※</span></label>
					</th>
					<td>
						<div class="col-10">

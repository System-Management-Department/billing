			...
			<div>
				<div class="card mb-4">
					...
					<div class="card-body d-flex flex-column gap-3">
						<div data-estimate="1" class="d-flex gap-3">
						...
						<div data-estimate="2" class="d-flex gap-3">
						...
						<div data-estimate="3" class="d-flex gap-3">
						...
						<div data-estimate="4" class="d-flex gap-3">

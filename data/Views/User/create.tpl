{block name="title"}ユーザー登録画面{/block}
		...
		<div class="row">
			<table class="table w-50">
				<tr>
					...
					<td>
						<div class="col-10">
							<input type="text" name="username" class="form-control" id="username-input" autocomplete="off" />
				...
				<tr>
					...
					<td>
						<div class="col-10">
							<input type="email" name="email" class="form-control" id="email-input" autocomplete="off" />
							<div class="invalid-feedback"></div>
						</div>
					</td>
				</tr>
				<tr>
					...
					<td>
						<div class="col-10">
							<input type="password" name="password" class="form-control" id="password-input" autocomplete="off" />
							<div class="invalid-feedback"></div>
						</div>
					</td>
				</tr>

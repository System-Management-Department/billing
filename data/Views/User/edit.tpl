{block name="title"}ユーザー編集画面{/block}
			...
			<table class="table w-50">
				<tr>
					<th scope="row" class="bg-light align-middle ps-4">
						<label class="form-label ls-1" for="username-input">ユーザー名　<span class="text-danger fw-light">※</span></label>
					</th>
					<td>
						<div class="col-10">
							<input type="text" name="username" class="form-control" id="username-input" autocomplete="off" value="{$data.username|escape:"html"}" />
				...
				<tr>
					<th scope="row" class="bg-light align-middle ps-4">
						<label class="form-label ls-1" for="email-input">メールアドレス　<span class="text-danger fw-light">※</span></label>
					</th>
					<td>
						<div class="col-10">
							<input type="email" name="email" class="form-control" id="email-input" autocomplete="off" value="{$data.email|escape:"html"}" />
							<div class="invalid-feedback"></div>
						</div>
					</td>
				</tr>
				<tr>
					<th scope="row" class="bg-light align-middle ps-4">
						<label class="form-label ls-1" for="password-input">パスワード　<span class="text-danger fw-light">※</span></label>
					</th>
					<td>
						<div class="col-10">
							<input type="password" name="password" class="form-control" id="password-input" autocomplete="off" value="{$data.password|escape:"html"}" />
							<div class="invalid-feedback"></div>
						</div>
					</td>
				</tr>
				<tr>
					<th scope="row" class="bg-light align-middle ps-4">
						<label class="form-label ls-1" for="role-input">権限　<span class="text-danger fw-light">※</span></label>
					</th>
					<td>
						<div class="col-10">
							<select name="role" class="form-select" id="role-input">{foreach from=["" => "選択"]|role item="text" key="value"}
								<option value="{$value}"{if $data.role eq $value} selected{/if}>{$text}</option>
							{/foreach}</select>
							<div class="invalid-feedback"></div>
						</div>
					</td>
				...
				<tr>
					...
					<td>
						<div class="col-10">
							<input type="text" name="department" class="form-control" id="department-input" autocomplete="off" value="{$data.department|escape:"html"}" />
							<div class="invalid-feedback"></div>
						</div>
					</td>
				</tr>

{block name="title"}担当者編集画面{/block}
	...
	<div class="container border border-secondary rounded p-4 mb-5 bg-white">
		<div class="row">
			<table class="table w-50">
				...
				<tr>
					<th scope="row" class="bg-light align-middle ps-4">
						<label class="form-label ls-1" for="name-input">担当者名　<span class="text-danger fw-light">※</span></label>
					</th>
					<td>
						<div class="col-10">
				...
				<tr>
					<th scope="row" class="bg-light align-middle ps-4">
						<label class="form-label ls-1" for="kana-input">担当者名カナ　<span class="text-danger fw-light">※</span></label>
					</th>
					<td>
						<div class="col-10">

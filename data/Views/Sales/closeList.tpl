...
new VirtualPage("/", class{
	constructor(vp){
		...
		const fields = [
			...
			{header: "消費税",             query: "sales_slips.amount_exc * 0.1"},
			{header: "合計金額",           query: "sales_slips.amount_exc * 1.1"},
			...
			{header: "請求金額",           query: "sales_slips.amount_exc * 1.1"},
			...
			{header: "消費税(明細別合計)", query: "sales_slips.amount_exc * 0.1"},
			{header: "税込金額(明細合計)", query: "sales_slips.amount_exc * 1.1"},
